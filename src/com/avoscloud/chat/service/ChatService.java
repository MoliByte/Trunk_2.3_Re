...
public class ChatService {
	...
	public static <T extends com.avos.avoscloud.AVUser> void withUsersToWatch(
			List<T> users, boolean watch) {
	...
	public static List<Conversation> getConversationsAndCache()
		...
		DBHelper dbHelper = new DBHelper(MyApplication.ctx,
				MyApplication.DB_NAME, MyApplication.DB_VER);
...
//		Intent intent;
//		if (group == null) {
//			intent = LeanCloudChatActivity.getUserChatIntent(context,
//					msg.getFromPeerId());
//		} else {
//			intent = LeanCloudChatActivity.getGroupChatIntent(context,
//					group.getGroupId());
//		}
	...
	public static void handleReceivedMsg(final Context context, final Msg msg,
		...
		new NetAsyncTask(context, false) {
			...
			protected void onPost(Exception e) {
				if (e != null) {
					Utils.toast(context, context.getResources().getString(R.string.badNetwork));
				} else {
					DBMsg.insertMsg(msg);
