...
public class PhotoUtils {
	...
	public static String compressImage(String path, String newPath,int angle) {
		try {
			BitmapFactory.Options options = new BitmapFactory.Options();
			options.inJustDecodeBounds = true;
			BitmapFactory.decodeFile(path, options);
	...
	//文章专题、活动、晚九点
	public static DisplayImageOptions articleImageOptions = new DisplayImageOptions.Builder()
			.showImageOnLoading(R.drawable.home_default)
			.showImageForEmptyUri(R.drawable.home_default)
			.showImageOnFail(R.drawable.home_default).cacheInMemory(true)
	...
	//管家小哥图片
	public static DisplayImageOptions guanJiaImageOptions = new DisplayImageOptions.Builder()
			.showImageOnLoading(R.drawable.my_pic_default)
			.showImageForEmptyUri(R.drawable.my_pic_default)
			.showImageOnFail(R.drawable.my_pic_default).cacheInMemory(true)
			.cacheOnDisc(true).considerExifParams(true)
			.imageScaleType(ImageScaleType.EXACTLY)
			.bitmapConfig(Config.RGB_565).resetViewBeforeLoading(true)// 设置图片在下载前是否重置，复位
			// .displayer(new RoundedBitmapDisplayer(20))
	...
	//管家小哥,默认用户图像
	public static DisplayImageOptions myPicImageOptions = new DisplayImageOptions.Builder()
			.showImageOnLoading(R.drawable.my_pic_default)
			.showImageForEmptyUri(R.drawable.my_pic_default)
			.showImageOnFail(R.drawable.my_pic_default).cacheInMemory(true)
			.cacheOnDisc(true).considerExifParams(true)
