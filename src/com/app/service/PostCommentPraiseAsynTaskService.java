...
public class PostCommentPraiseAsynTaskService implements HttpAysnTaskInterface{
	...
	private final static String TAG = "PostCommentPraiseAsynTaskService-->";
	private final static String ROOT = "object" ;
	private Context context;
	private Integer mTag;// Action 标签
	private HttpAysnResultInterface callback ;
	
	public PostCommentPraiseAsynTaskService(Context context, Integer mTag,HttpAysnResultInterface callback) {
	...
	public void doPostCommentPraise(long comment_id,String token) {
		try {
			...
			client.post_with_head_and_body(context, mTag,v1_comment_praise,mapHead, bodyEntity,PostCommentPraiseAsynTaskService.this);
		} catch (Exception e) {
