...
public class PostHomePraiseService implements HttpAysnTaskInterface{
	private Context context;
	private Integer mTag;// Action 标签
	private HttpAysnResultInterface callback ;

	public PostHomePraiseService(Context context, Integer mTag,
	...
	public void doPraise(String token,String action,String source_type,int source_id){
		try{
