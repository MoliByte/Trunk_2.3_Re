...
/**
 * Created by lidewen on 14-4-25.
 */
public class HorizontalProgressDialog extends AlertDialog {

    /** Creates a HorizontalProgressDialog with a circular, spinning progress
     * bar. This is the default.
     */
    public static final int STYLE_SPINNER = 0;

    /** Creates a HorizontalProgressDialog with a horizontal progress bar.
     */
    ...
    public static HorizontalProgressDialog show(Context context, CharSequence title,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewUpdateHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                String message = mMessage+"（"+progress+"%）";
                setMessage(message);
            }
        };
