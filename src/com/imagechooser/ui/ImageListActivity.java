...
import com.imagechooser.ui.adapter.ImageListAdapter;
import com.imagechooser.utils.Util;
...
public class ImageListActivity extends BaseActivity implements OnItemClickListener {
    ...
    private final int IMAGE_LIST_REQUEST_CODE = 2; 
    @Override
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        //startActivity(i);
        startActivityForResult(i, IMAGE_LIST_REQUEST_CODE);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {       
        ...
        if(requestCode==IMAGE_LIST_REQUEST_CODE && data != null){  
