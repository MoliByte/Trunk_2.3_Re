    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            */
            ...
            //绘制中间的线,每次刷新界面，中间的线往下移动SPEEN_DISTANCE，自己加
          ...
          //  paint.setAlpha(0x40);
            ...
            String text = getResources().getString(R.string.zxing_msg_default_status);
            ...
            paint.setAlpha(0x40);
            paint.setTypeface(Typeface.create("System", Typeface.BOLD));
            String t = getResources().getString(R.string.zxing_msg_default_status2);
            float tw = paint.measureText(t);

            canvas.drawText(t, (width - tw)/2, (float) (frame.bottom + (float)TEXT_PADDING_TOP *density+20*density), paint);
            
            paint.setColor(Color.WHITE);
            paint.setTextSize(14 * density);
            paint.setTypeface(Typeface.create("System", Typeface.BOLD));
            String text2 = getResources().getString(R.string.zxing_msg_default_status3);
            float textWidth2 = paint.measureText(text2);
            
            canvas.drawText(text2, (width - textWidth2)/2, (float) (frame.bottom + (float)TEXT_PADDING_TOP *density+20*2*density), paint);
