...
import com.zxing.client.android.PreferencesConfig;
...
/*
    ...
    /**
     * Like {@link #launchIntent(android.content.Intent)} but will tell you if it is not
     * handle-able via {@link android.content.ActivityNotFoundException}.
     *
    ...
    /**
     * Like {@link #rawLaunchIntent(android.content.Intent)} but will show a user dialog if
    ...
    final void launchIntent(Intent intent) {
        try {
            ...
            builder.setMessage(R.string.zxing_msg_intent_failed);
    ...
    private String parseCustomSearchURL() {
        ...
        String customProductSearch = prefs.getString(PreferencesConfig.KEY_CUSTOM_PRODUCT_SEARCH,
                null);
