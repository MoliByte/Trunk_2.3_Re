...
import com.skinrun.wheel.city.widget.adapters.WheelViewAdapter;
...
public class WheelViewCity extends View {
	 ...
	 * Constructor
	 */
	public WheelViewCity(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public WheelViewCity(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
