...
package com.beabox.hjy.tt.main.settings.handler;
...
import com.zxing.client.android.DecodeThread;
import com.zxing.client.android.ViewfinderResultPointCallback;
 ...
 */
public final class SweepHandler extends Handler {

    private static final String TAG = SweepHandler.class.getSimpleName();
    ...
    public SweepHandler(SweepActivity activity, Collection<BarcodeFormat> decodeFormats,
    ...
    public void handleMessage(Message message) {
        switch (message.what) {
            ...
            case R.id.decode_succeeded:
                ...
                activity.handleDecode((Result) message.obj,false);
                break;
