...
public class PhotoShareActivity extends Activity implements OnClickListener,
	...
	public void onClick(View v) {
		...
		case R.id.overlay0:
			...
			catonImageComp.setImageResourse(0);
			
			break;
		case R.id.overlay1:
			findViewById(R.id.ctImageGroupInner).setSelected(true);
			findViewById(R.id.ctImageGroup).setVisibility(View.VISIBLE);
			catonImageComp.setImageResourse(1);
			
			break;
		case R.id.overlay2:
			findViewById(R.id.ctImageGroupInner).setSelected(true);
			findViewById(R.id.ctImageGroup).setVisibility(View.VISIBLE);
			catonImageComp.setImageResourse(2);
			
			break;
		case R.id.overlay3:
			findViewById(R.id.ctImageGroupInner).setSelected(true);
			findViewById(R.id.ctImageGroup).setVisibility(View.VISIBLE);
			catonImageComp.setImageResourse(3);
			
			break;
		case R.id.overlay4:
			findViewById(R.id.ctImageGroupInner).setSelected(true);
			findViewById(R.id.ctImageGroup).setVisibility(View.VISIBLE);
			catonImageComp.setImageResourse(4);
			break;
		case R.id.container:
		...
		case R.id.sign1:
			...
			ivSign.setImageDrawable(getResources().getDrawable(R.drawable.overlay16));
			break;
		case R.id.sign2:
			findViewById(R.id.userInfoGroupInner).setSelected(true);
			findViewById(R.id.userInfoGroup).setVisibility(View.VISIBLE);
			ivSign.setImageDrawable(getResources().getDrawable(R.drawable.overlay17));
			break;
		case R.id.sign3:
			findViewById(R.id.userInfoGroupInner).setSelected(true);
			findViewById(R.id.userInfoGroup).setVisibility(View.VISIBLE);
	...
	private void makFilter(final View view, final IImageFilter filter) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				final Bitmap filterBitmap = makeFilter(maxBitmap, filter);
	...
	private void initView() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				final Bitmap blackWhite = makeFilter(minBitmap,
						new FilmFilter());
				mHandler.post(new Runnable() {
					@Override
					public void run() {
						...
						blackWhiteImage
								.setOnClickListener(PhotoShareActivity.this);
					}
				});

				final Bitmap blur = makeFilter(minBitmap, new SaturationModifyFilter());
				mHandler.post(new Runnable() {
					@Override
					public void run() {
						blurImage.setImageBitmap(blur);
						blurImage.setOnClickListener(PhotoShareActivity.this);
					}
				});

				final Bitmap lomo = makeFilter(minBitmap, new NewLomoFilter());
				mHandler.post(new Runnable() {
					@Override
					public void run() {
						lomoImage.setImageBitmap(lomo);
						lomoImage.setOnClickListener(PhotoShareActivity.this);
					}
				});

				final Bitmap softGlow = makeFilter(minBitmap, new BrightContrastFilter());
				mHandler.post(new Runnable() {
					@Override
					public void run() {
