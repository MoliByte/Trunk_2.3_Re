...
public class SaveSkinTypeActivity extends BaseActivity{
	...
	private void save_nick_name() {
		...
		new Handler().postDelayed(new Runnable() {
			...
			public void run() {
				...
				new UpdateNickNameService(SaveSkinTypeActivity.this, HttpTagConstantUtils.UPDATE_NICK_NAME,
						SaveSkinTypeActivity.this).doNickNameUpdate(Token, nick_name.getText().toString());
