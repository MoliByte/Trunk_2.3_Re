...
public class SaveNickNameActivity extends BaseActivity{
	...
	private View save_nickname_btn ;
	...
	public void setupView() {
		...
		save_nickname_btn =  findViewById(R.id.save_nickname_btn);
	...
	private void save_nick_name() {
		if(StringUtil.isBlank(nick_name.getText().toString())){
			AppToast.toastMsgCenter(this, "请输入昵称!").show();
			return ;
		}
		...
		new Handler().postDelayed(new Runnable() {
			...
			public void run() {
				...
				new UpdateNickNameService(SaveNickNameActivity.this, HttpTagConstantUtils.UPDATE_NICK_NAME,
						SaveNickNameActivity.this).doNickNameUpdate(Token, nick_name.getText().toString());
