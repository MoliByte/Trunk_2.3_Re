...
import com.idongler.imagefilter.Palette;
...
public class GradientFilter implements IImageFilter {
    ...
    private float OriginAngleDegree;
    ...
    public float getOriginAngleDegree() {
        return OriginAngleDegree;
    }

    public void setOriginAngleDegree(float originAngleDegree) {
        OriginAngleDegree = originAngleDegree;
    }
