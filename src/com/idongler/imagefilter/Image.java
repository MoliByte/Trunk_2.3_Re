...
package com.idongler.imagefilter;
...
public class Image {
    ...
    boolean copyPixelsFromBuffer = true;
    ...
    public void copyPixelsFromBuffer() {
        if(copyPixelsFromBuffer){
            ...
            destImage.setPixels(colorArray, 0, width, 0, 0, width, height);
        }
    }
    ...
    public boolean isCopyPixelsFromBuffer() {
        return copyPixelsFromBuffer;
    }

    public void setCopyPixelsFromBuffer(boolean copyPixelsFromBuffer) {
        this.copyPixelsFromBuffer = copyPixelsFromBuffer;
    }
